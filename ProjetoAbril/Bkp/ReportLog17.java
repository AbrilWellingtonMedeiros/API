...
public class ReportLog17 extends TestUtils {
...
//			// Cabeçalho todas as marcas
//			PdfPTable table = new PdfPTable(5);
//			    table.addCell(new PdfPCell(new Paragraph("Marca")));
//			    table.addCell(new PdfPCell(new Paragraph("Abertas")));
//			    table.addCell(new PdfPCell(new Paragraph("Contabilizado")));
//			    table.addCell(new PdfPCell(new Paragraph("Fechado")));
