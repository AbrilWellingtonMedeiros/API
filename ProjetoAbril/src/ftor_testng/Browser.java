...
public class Browser extends TestUtils {
	...
	public static String path_Chrome_Driver_headless = (Utils.userDir + "\\utilitarios\\driverJunit\\drivers\\chromedriver_2.40headless.exe");
	...
	public static String path_PhantomJS_2_11 = (Utils.userDir + "\\utilitarios\\phantomjs-2.1.1\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe");
	...
	public static void executarComChrome97() {
		/********************************
		 * Chrome 70 + chromedriver 2.40
		 ********************************/
		System.setProperty("webdriver.chrome.driver", path_Chrome_Driver_2_40);
	...
	public static void executarComChrome70_Headless() {
		 ...
		 ******************************************/
		System.setProperty("webdriver.chrome.driver", path_Chrome_Driver_headless);
	...
	public static void executarComChromePortable() {
		...
		System.setProperty("webdriver.chrome.driver", path_Chrome_Portable_67);
