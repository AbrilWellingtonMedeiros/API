          ...
          // tlDriver = ThreadLocal.withInitial(() -> new FirefoxDriver(OptionsManager.getFirefoxOptions()));
            ...
            try {
               ...
               //tlDriver.set(new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"), OptionsManager.getFirefox()));  //local
            	...
            	tlDriver.set(new RemoteWebDriver(new URL("http://10.95.2.155:4444/wd/hub"), OptionsManager.getFirefox()));  // funcionou    servidor                     
           ...
           // tlDriver.set(new ChromeDriver(OptionsManager.getChromeOptions()));
            ...
            try {
                ...
                tlDriver.set(new RemoteWebDriver(new URL("http://10.95.2.155:4444/wd/hub"), OptionsManager.getChrome()));  // funcionou    servidor 
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                tlDriver.set(new RemoteWebDriver(new URL("http://10.95.2.155:4444/wd/hub"), OptionsManager.getInternetExplorer()));  // funcionou    servidor 
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }
